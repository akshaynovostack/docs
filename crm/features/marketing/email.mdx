...
![email](https://ruloans-bucket.s3.ap-south-1.amazonaws.com/docs/crm/features/marketing/email/email.png)
...
![email2](https://ruloans-bucket.s3.ap-south-1.amazonaws.com/docs/crm/features/marketing/email/email2.png)

## **4. Create a New Email Template**

* Click on the **Add Email Template** button.![email3](https://ruloans-bucket.s3.ap-south-1.amazonaws.com/docs/crm/features/marketing/email/email3.png)

* The Template Editor page will open.


  ![email4](https://ruloans-bucket.s3.ap-south-1.amazonaws.com/docs/crm/features/marketing/email/email4.png)
...
![email5](https://ruloans-bucket.s3.ap-south-1.amazonaws.com/docs/crm/features/marketing/email/email5.png)
...
![email6](https://ruloans-bucket.s3.ap-south-1.amazonaws.com/docs/crm/features/marketing/email/email6.png)
...
![email7](https://ruloans-bucket.s3.ap-south-1.amazonaws.com/docs/crm/features/marketing/email/email7.gif)
...
* Next to each template, click on the **Three Dots** (⋮) to access more options:
  ...
  ![email8](https://ruloans-bucket.s3.ap-south-1.amazonaws.com/docs/crm/features/marketing/email/email8.png)
...
![email9](https://ruloans-bucket.s3.ap-south-1.amazonaws.com/docs/crm/features/marketing/email/email9.png)
...
![email10](https://ruloans-bucket.s3.ap-south-1.amazonaws.com/docs/crm/features/marketing/email/email10.gif)
